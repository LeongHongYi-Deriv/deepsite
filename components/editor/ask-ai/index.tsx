...
// import { LoginModal } from "@/components/login-modal"; // REMOVED - HF auth dependency
...
export function AskAI({
  ...
  // const [open, setOpen] = useState(false); // REMOVED - was for LoginModal
  ...
  const handleError = (error: string, message?: string) => {
    switch (error) {
      case "login_required":
        // setOpen(true); // REMOVED - LoginModal no longer available
        console.warn("Login required but authentication disabled");
        break;
